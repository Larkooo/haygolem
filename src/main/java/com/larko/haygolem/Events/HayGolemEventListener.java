...
public class HayGolemEventListener {
    ...
    public static void onPlayerInteract(PlayerInteractEvent.EntityInteract event)
    {
        ...
        event.getPlayer().openMenu(new SimpleMenuProvider((p_53124_, p_53125_, p_53126_) -> ChestMenu.threeRows(p_53124_, p_53125_, entity.getInventory()), new TextComponent("HayGolem")));
    }
